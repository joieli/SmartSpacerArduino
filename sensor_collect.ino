...
float calculate_volflow(float pa){
  ...
  if(pa < 0){
    ...
    vol_flow = sqrt((2*pa)/(1.293*((1/pow(0.000182,2))-(1/pow(0.0013795,2)))))*60000;
  }  
  return vol_flow;
}
