...
void loop_inner() {
  if(hasConfig == true)
  {
    ...
    if(inPEFRMode == false){
      if(hasInhaler == false){
        if(nextPressed == true){
          ...
          curInhaler.type = "bronchodilator";
          curInhaler.color = "blue";
          curInhaler.commercialName = "Ventolin";
          curInhaler.medication = "100mcg/puff Salbutamol";
          ...
          //orange inhaler is attached
          //blue inhaler is attached
          redoPressed = false; //reset the flag
          hasInhaler = true;
          
          curInhaler.startTime = getTime();
          lastInhaleAboveThresh = millis();

          curInhaler.type = "corticosteroid";
          curInhaler.color = "orange";
          curInhaler.commercialName = "Flovent";
          curInhaler.medication = "50mcg/puff Fluticasone";
      ...
      //second priority is toggle inhaler mode off
      else if (hasInhaler == true && (nextPressed == true || redoPressed == true))
      {
        nextPressed = false; //reset flag
        redoPressed = false; //reset flag
        hasInhaler = false;
    ...
    if(config.PEFRActive == true && hasInhaler == false)  //third priority is toggling the isPEFRMode on and off/moving to next trial
    {
